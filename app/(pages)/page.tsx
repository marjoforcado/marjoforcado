      ...
      <div className="max-w-5xl mx-auto space-y-4 px-6">
        ...
        <div className="space-y-4 container">
          ...
          >
            <div className="space-y-4">
              <p className="text-muted-foreground">
                Design and architected the cloud infrastructure or our
                application ensuring scalability, reliability, and security.
                With my expertise in both frontend and backend development, I
                led the implementation of robust systems, implementing
              ...
              <p className="text-muted-foreground">
                ...
                aligns with our strategic goals. My role involves not only
                coding and system design but also mentoring the team, driving
                innovation, and fostering a culture of excellence and
                collaboration.
              </p>
          ...
          >
            ...
            frontend modules, collaborated closely with cross-functional teams
